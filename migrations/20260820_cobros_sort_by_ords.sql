-- Migracion ORDS: sort_by (date|price) + sort_dir (asc|desc) en GET /workspace/payments
-- Modulo hasel. Binds :sort_by (default date) y :sort_dir (default desc).
...
PROMPT === ORDS workspace/payments sort_by registrado ===
