...
COMMENT ON COLUMN ref_odontogram_finding.visual_kind IS 'Intencion de render: FACES se pinta como TINT en el GLB monolitico; GHOST/HIDE/CROWN son modos 3D propios.';
